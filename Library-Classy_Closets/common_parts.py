...
STRAIGHT_COUNTER_TOP = path.join(path.dirname(__file__),"Closet Assemblies","Countertop.blend")    
ISLAND_COUNTER_TOP = path.join(path.dirname(__file__),"Closet Assemblies","Island Countertop.blend")
...
STRAIGHT_CC_COUNTER_TOP = path.join(path.dirname(__file__),"Closet Assemblies","CC Countertops","Straight Countertop.blend")  
CORNER_CC_COUNTER_TOP = path.join(path.dirname(__file__),"Closet Assemblies","CC Countertops","Corner Countertop.blend")  

OBJECT_DIR = path.join(path.dirname(__file__),"Closet Objects")
