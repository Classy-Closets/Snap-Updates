...
class PROPS_Pricing(bpy.types.PropertyGroup):
    ...
    def export_properties(self):
        closet_utils.set_room_prop("Product Library: Material Price Total",str(self.material_price_total))
        closet_utils.set_room_prop("Product Library: Hardware Price Total",str(self.hardware_price_total))
        closet_utils.set_room_prop("Product Library: Door and Drawer Front Price Total",str(self.door_drawer_price_total))
        closet_utils.set_room_prop("Product Library: Molding Price Total",str(self.molding_price_total))
        closet_utils.set_room_prop("Product Library: Hanging Rod Price Total",str(self.hanging_rod_price_total))
        ...
        closet_utils.set_room_prop("Product Library: Closet Price Total",str(project_total))
        closet_utils.set_room_prop("Product Library: Sheet Material Sq Ft Total",str(self.sheet_material_qty))
        closet_utils.set_room_prop("Product Library: Hanging Rod LFt Total",str(self.hanging_rod_qty))
        closet_utils.set_room_prop("Product Library: Pull Qty",str(self.pull_qty))
        closet_utils.set_room_prop("Product Library: Slide Qty",str(self.slide_qty))
        closet_utils.set_room_prop("Product Library: Cam Qty",str(self.cam_qty))
        closet_utils.set_room_prop("Product Library: Hinge Qty",str(self.hinge_qty))
        closet_utils.set_room_prop("Product Library: Shelf Pin Qty",str(self.shelf_pin_qty))
        closet_utils.set_room_prop("Product Library: Wire Basket Qty",str(self.wire_basket_qty))
        closet_utils.set_room_prop("Product Library: Hamper Qty",str(self.hamper_qty))
        closet_utils.set_room_prop("Product Library: Door Qty",str(self.door_qty))
        closet_utils.set_room_prop("Product Library: Drawer Front Qty",str(self.drawer_front_qty))
        closet_utils.set_room_prop("Product Library: Drawer Box Qty",str(self.drawer_box_qty))
        closet_utils.set_room_prop("Product Library: Molding Qty",str(self.molding_qty))
        
        # closet_utils.set_room_prop("Product Library: Pull Name",self.pull_name)
        # closet_utils.set_room_prop("Product Library: Slide Name",self.slide_name)
        # closet_utils.set_room_prop("Product Library: Slide Name",self.hinge_name)
