...
class TOPBAR_MT_help(Menu):
    ...
    def draw(self, context):
        ...
        layout.operator("wm.url_open", text="SNaP Release Log", icon='URL').url = "https://classy-closets.github.io/SNaP-2.0/release_notes"
        layout.operator("wm.url_open", text="SNaP Help", icon='URL').url = "https://classy-closets.github.io/SNaP-2.0/FAQ"
