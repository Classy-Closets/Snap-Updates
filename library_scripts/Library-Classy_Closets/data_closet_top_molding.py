...
class Flat_Crown(fd_types.Assembly):
    ...
    def draw(self):
        ...
        flat_crown.z_loc('Molding_Height+Molding_Location',[Molding_Height,Molding_Location])
        ...
        left_return.z_loc('Molding_Location', [Molding_Location])
        ...
        right_return.z_loc('Molding_Location',[Molding_Location])
...
#         self.update_product_size()
    ...
    def draw(self, context):
        ...
        return_rightt = self.insert.get_prompt("Return Right")      
...
#         extend_right.draw_prompt(row,text="Right",split_text=False)
        ...
        return_rightt.draw_prompt(row,text="Right Return",split_text=False)
        row = box.row()
